package com.rm.toolkit.mediaStorage.command.security.jwt;
...
public class JwtUtil {
    ...
    public Integer getRolePriorityFromHeader(String header) {
        return getClaimsFromJwtToken(getTokenFromHeader(header)).get("rolePriority", Integer.class);
    }
