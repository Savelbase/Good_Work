...
@Entity
@DiscriminatorValue("FEEDBACK_UPDATED")
@Data
@SuperBuilder
@EqualsAndHashCode(callSuper = true)
public class FeedbackEditedEvent extends Event<FeedbackEditedEvent.Payload> {

    public FeedbackEditedEvent() {
        this.type = EventType.FEEDBACK_UPDATED;
    }
